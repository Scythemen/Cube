...
namespace Cube.Utility.SequentialGuid
{
    ...
    public class SequentialGuidGenerator : IGenerator
    {
        ...
        {
            Options = options ?? new SequentialGuidOptions();
        }

        public Guid NewGuid() => CreateGuid(Options.GuidType);

        static Guid CreateGuid(SequentialGuidType guidType)
        {
