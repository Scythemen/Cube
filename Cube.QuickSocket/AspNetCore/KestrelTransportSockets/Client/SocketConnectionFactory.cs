...
using Cube.QuickSocket.AspNetCore.Transport.Internal;
...
// https://github.com/dotnet/aspnetcore/blob/v7.0.10/src/Servers/Kestrel/Transport.Sockets/src/Client/SocketConnectionFactory.cs
...
internal sealed class SocketConnectionFactory : IConnectionFactory, IAsyncDisposable
{
    ...
    public SocketConnectionFactory(IOptions<SocketTransportOptions> options, ILoggerFactory loggerFactory)
    {
        ...
        // modify
        // https://github.com/dotnet/aspnetcore/blob/v7.0.10/src/Servers/Kestrel/Transport.Sockets/src/SocketConnectionFactoryOptions.cs
        // internal Func<MemoryPool<byte>> MemoryPoolFactory { get; set; } = System.Buffers.PinnedBlockMemoryPoolFactory.Create;
        _memoryPool = Cube.QuickSocket.AspNetCore.Buffers.PinnedBlockMemoryPoolFactory.Create();
        ...
        var applicationScheduler =
            _options.UnsafePreferInlineScheduling ? PipeScheduler.Inline : PipeScheduler.ThreadPool;
        var transportScheduler = applicationScheduler;
        // https://github.com/aspnet/KestrelHttpServer/issues/2573
        var awaiterScheduler = OperatingSystem.IsWindows() ? transportScheduler : PipeScheduler.Inline;

        _inputOptions = new PipeOptions(_memoryPool, applicationScheduler, transportScheduler, maxReadBufferSize,
            maxReadBufferSize / 2, useSynchronizationContext: false);
        _outputOptions = new PipeOptions(_memoryPool, transportScheduler, applicationScheduler, maxWriteBufferSize,
